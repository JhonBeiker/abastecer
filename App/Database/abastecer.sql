...
CREATE TABLE `clap` (
  ...
  `limiteSurComunidad` int(40) NOT NULL,
...
CREATE TABLE `enlace_politico` (
  ...
  `parroquiaEncargado` varchar(20) COLLATE utf8_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
...
CREATE TABLE `solicitud` (
  ...
  `exposicion` text COLLATE utf8mb4_spanish2_ci NOT NULL,
...
CREATE TABLE `usuario` (
  ...
  `passwordUsuarion` varchar(255) COLLATE utf8mb4_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
