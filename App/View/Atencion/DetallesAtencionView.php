                ...
                <div class="row">
                    <form action="" method="post" class="col s12">
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m6 xl4 input-field">
                                <i class="icon-local_mall grey-text prefix"></i>
                                <input type="number" min="1" id="cantBolsas" name="cantBolsas" class="validate" value="1000" disabled>
                                <label for="cantBolsas">Bolsas Entregadas</label>
                            </div>
                            <div class="col s12 m6 xl4 input-field">
