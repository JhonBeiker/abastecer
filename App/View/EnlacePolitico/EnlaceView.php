                ...
                <div class="row">
                    <ul class="collection">
                        <li class="collection-item avatar">
                            <i class="icon-record_voice_over red-text grey lighten-4 circle icon-tam"></i>
                        ...
                        <li class="collection-item avatar">
                            ...
                            <a href="<?php echo $helper->url('EnlacePolitico','read') ?>" class="secondary-content"><i class="icon-search icon-tam"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
