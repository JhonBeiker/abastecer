                        ...
                        <table class="centered highlight">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="#modal-1" class="btn-floating waves-effect waves-light blue modal-trigger"><i class="icon-update"></td>
                                    <td><a href="#modal-2" class="btn-floating waves-effect waves-light red  modal-trigger"><i class="icon-delete"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
