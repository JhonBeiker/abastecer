                ...
                <div class="row">
                    <ul class="collection">
                        ...
                        <li class="collection-item avatar">
                            ...
                            <a href="<?php echo $helper->url('EnlacePolitico','index'); ?>" class="secondary-content indigo-text"><i class="icon-record_voice_over icon-tam"></i></a>
                        </li>
                        <li class="collection-item avatar">
                            <i class="icon-streetview red-text grey lighten-4 circle icon-tam"></i>
                            <span class="title">Gestionar Cargo</span>
                            <p>Registra, consulta y elimina los enlaces políticos que aprueban la conformación de un CLAP.</p>
                            <a href="<?php echo $helper->url('Cargo','index'); ?>" class="secondary-content indigo-text"><i class="icon-record_voice_over icon-tam"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
