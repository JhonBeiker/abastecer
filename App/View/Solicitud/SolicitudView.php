                ...
                <div class="row">
                    <ul class="collection">
                        <li class="collection-item avatar">
                            <i class=" icon-work brown-text grey lighten-4 circle icon-tam"></i>
                            <span class="title">Registrar Solicitud</span>
                            <p>Registra las solicitudes de la comunidad.</p>
                            <a href="RegistrarSolicitudView.php" class="secondary-content  green-text accent-4"><i class="icon-group_add icon-tam"></i></a>
                        </li>
                        <li class="collection-item avatar">
                            <i class="icon-work brown-text grey lighten-4 circle icon-tam"></i>
                            <span class="title">Consultar Solicitud</span>
                            <p>Consulta las solicitudes registradas en la aplicación.</p>
                            <a href="ConsultarSolicitudView.php" class="secondary-content">
